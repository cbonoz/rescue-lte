...
public class CameraStoragePermissionsHelper extends Fragment {
    ...
    public static boolean hasSelfPermission(AppCompatActivity activity, String[] permissions) {
    ...
    public void checkStoragePermissions() {
        if (isMOrAbove()) {
            if (hasSelfPermission((AppCompatActivity) getActivity(), new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE})) {
    ...
    public void checkCameraStoragePermissions() {
        if (isMOrAbove()) {
            if (hasSelfPermission((AppCompatActivity) getActivity(), new String[]{Manifest.permission.CAMERA, Manifest.permission.WRITE_EXTERNAL_STORAGE})) {
